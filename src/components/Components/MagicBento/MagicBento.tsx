...
const cardData: BentoCardProps[] = [
  {
    color: "rgba(6,0,16,0.25)",
    title: "Portfolio Showcase",
    description: "Highlight your best projects and skills",
    label: "Showcase",
  },
  {
    color: "rgba(6,0,16,0.25)",
    title: "Developer Feed",
    description: "Share updates, tips, and progress",
    label: "Updates",
  },
  {
    color: "rgba(6,0,16,0.25)",
    title: "Project Collaboration",
    description: "Work on code together in real-time",
    label: "Collab",
  },
  {
    color: "rgba(6,0,16,0.25)",
    title: "Skill Endorsements",
    description: "Get recognition from fellow developers",
    label: "Endorse",
  },
  {
    color: "rgba(6,0,16,0.25)",
    title: "Tech Discussions",
    description: "Exchange ideas and solve problems",
    label: "Discuss",
  },
  {
    color: "rgba(6,0,16,0.25)",
    title: "Achievements",
    description: "Earn badges for your milestones",
    label: "Badges",
  },
];
